...
func TestRunDirectAppliesChainResetKeyframeAndMarksIsChainStart(t *testing.T) {
	...
	st := VideoGenerationStep{Runner: indexedURLRunner{}, UsePreviousVideo: true, VideoProcessor: vp}
...
// (Verse -> Chorus) is marked IsChainStart like any other reset (so ChainFinalizeStep still
